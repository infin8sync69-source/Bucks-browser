...
const PUBLIC_ROUTES = ['/', '/login', '/recover', '/search', '/feed', '/chat', '/wallet', '/mining'];
...
export default function AuthGuard({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        const checkAuth = async () => {
            ...
            const isPublicRoute = PUBLIC_ROUTES.includes(normalizedPath) || pathname.startsWith('/profile/');
    ...
    const isPublicRoute = PUBLIC_ROUTES.includes(normalizedPathname) || pathname.startsWith('/profile/');
