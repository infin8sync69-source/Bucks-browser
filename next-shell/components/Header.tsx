...
import { Menu, X, LogOut, User, Settings, Home, Globe, MessageSquare, Bell, ArrowLeft, ArrowRight, RotateCw, Search, LayoutGrid, Moon, Clock, Bookmark } from 'lucide-react';
                            ...
                            <>
                                ...
                                <div className="absolute top-12 right-0 w-48 bg-[#0a0a0c]/95 backdrop-blur-3xl rounded-2xl p-2 shadow-2xl border border-white/10 animate-in fade-in zoom-in-95 duration-200">
                                    <div className="flex flex-col space-y-1">
                                        <button className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all text-left group">
                                            <Moon size={14} className="text-blue-400 group-hover:scale-110 transition-transform" />
                                            <span className="text-[10px] font-bold uppercase tracking-widest text-white/80">Light Mode</span>
                                        </button>
                                        <button className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all text-left group">
                                        ...
                                        <Link href="/settings" onClick={() => setIsSettingsOpen(false)} className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all text-left group">
